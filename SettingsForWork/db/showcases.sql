...
CREATE TABLE "catalogs" (
    ...
    main_photo text,
    date_create timestamp default current_timestamp,
    PRIMARY KEY (user_id, showcase_id, catalogs_id),
    -- FOREIGN KEY (user_id, showcase_id) REFERENCES showcases(user_id, showcase_id) ON DELETE CASCADE ON UPDATE CASCADE
);
-- таблица продукция
CREATE TABLE "products" (
    ...
    date_create timestamp default current_timestamp,
    PRIMARY KEY (user_id, showcase_id, catalog_id, product_id),
    -- FOREIGN KEY (user_id, showcase_id, catalog_id) REFERENCES catalogs(user_id, showcase_id, catalog_id) ON DELETE CASCADE ON UPDATE CASCADE,
